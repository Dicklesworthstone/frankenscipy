...
const ARMS: [&str; 3] = ["entropy", "relative_risk", "odds_ratio"];
...
fn diff_stats_entropy_ratios() {
    ...
    let mut ledger = CompareLedger::new("diff_stats_entropy_ratios", &ARMS);
    ...
    // The two contingency ratios have 4 fixtures each to entropy's 16.

...
fn diff_special_bessel() {
    ...
    let mut ledger = CompareLedger::new("diff_special_bessel", &ARMS);
    ...
    // Arms have different case sets (y0/y1 have no negative x); each must compare all of its own.

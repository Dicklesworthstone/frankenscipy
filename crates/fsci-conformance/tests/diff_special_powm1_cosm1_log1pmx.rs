...
const ARMS: [&str; 3] = ["powm1", "cosm1", "log1pmx"];
...
fn diff_special_powm1_cosm1_log1pmx() {
    ...
    let mut ledger = CompareLedger::new("diff_special_powm1_cosm1_log1pmx", &ARMS);
    ...
    // Arms have different case sets (cosm1 and log1pmx have the fewest); each must compare all
    // of its own.

...
pub use bessel::{
    ...
    BESSEL_Y01_HOIST_FLAG, BESSEL_Y01_HOIST_FLAG_HITS, IV_SERIES_TERM_RATIO,
    IV_SERIES_TERM_RATIO_HITS, h1vp, h2vp, hankel1, hankel1e, hankel2, hankel2e, i0, i0_scalar,
    i0e, i0e_scalar, i1, i1_scalar, i1e, i1e_scalar, iv, ive, ive_scalar, ivp, j0, j1, jn,
    jn_zeros, jnjnp_zeros, jnp_zeros, jnyn_zeros, jv, jve, jvp, k0, k0_scalar, k0e, k0e_scalar, k1,
    k1_scalar, k1e, k1e_scalar, kn, kn_scalar, kv, kve, kve_scalar, kvp, lmbda, log_ive_scalar,
    log_wright_bessel, riccati_jn, riccati_yn, spherical_in, spherical_jn, spherical_kn,
    spherical_yn, wright_bessel, y0, y0_zeros, y1, y1_zeros, y1p_zeros, yn, yn_zeros, ynp_zeros,
    yv, yve, yvp,
};
pub use beta::{
...
pub use error::{
    ERFCINV_NDTRI, ERFCINV_NDTRI_HITS, ERFINV_INFALLIBLE_BATCH, ERFINV_INFALLIBLE_BATCH_HITS,
...
pub use gamma::{
    ...
    GAMMA_DISPATCH_PLAN, GAMMA_FAMILY_PAR_MIN_OVERRIDE, GAMMA_FAMILY_PREALLOC_FILL,
    GAMMA_FAMILY_PREALLOC_FILL_HITS, GAMMA_FAMILY_SERIAL_HITS, GAMMA_INFALLIBLE_BATCH,
    GAMMA_INFALLIBLE_BATCH_HITS, GAMMALN_ASYMPTOTIC_MIN_OVERRIDE, GAMMALN_ASYMPTOTIC_MIN_X_DEFAULT,
    GAMMALN_CEPHES_LGAM, GAMMALN_CEPHES_LGAM_HITS, GAMMALN_HOIST_THRESHOLD,
    GAMMALN_HOIST_THRESHOLD_HITS, RGAMMA_CEPHES_CHEB, RGAMMA_CEPHES_CHEB_HITS,
    ZETA_CEPHES_RATIONAL, ZETA_CEPHES_RATIONAL_HITS, ZETA_DIRECT_EARLY_EXIT, binom, chdtr, chdtrc,
    chdtri, chdtriv, chdtriv_many, chndtr, chndtridf, chndtrinc, chndtrix, comb, digamma,
...
pub use orthopoly::{
    ...
    assoc_legendre_p_all, c_roots, cg_roots, chebyc, chebys, chebyt, chebyu, ellip_harm,
    ellip_harm_2, ellip_normal, eval_chebyc, eval_chebys, eval_chebyt, eval_chebyu,
    eval_gegenbauer, eval_genlaguerre, eval_hermite, eval_hermitenorm, eval_jacobi, eval_laguerre,
    eval_legendre, eval_sh_chebyt, eval_sh_chebyu, eval_sh_jacobi, eval_sh_legendre, gegenbauer,
    genlaguerre, h_roots, he_roots, hermite, hermitenorm, j_roots, jacobi, js_roots, l_roots,
    la_roots, laguerre, legendre, legendre_p, legendre_p_all, lpmn, lpmv, lpn, lqmn, lqn,
...
mod tests {
    ...
    fn yv_finite_at_non_integer_orders_above_one() {
        ...
        let cases: [(f64, f64, f64); 9] = [
            ...
            (1.5, 5.0, 0.321_924_442_961_140_2),
            (2.5, 5.0, 0.294_372_374_961_792_5),
            (2.5, 10.0, -0.16417847961494103),
            (1.3, 5.0, 0.26631384911040207),
            (1.7, 5.0, 0.356_264_127_687_647_9),
            (2.3, 5.0, 0.335_540_080_653_554_2),
    ...
    fn hurwitz_zeta_matches_scipy_at_small_s() {
        ...
        let cases: [(f64, f64, f64); 7] = [
            ...
            (2.0, 0.5, 4.934_802_200_544_68),
            (2.0, 3.0, 0.3949340668482265),
            (3.0, 1.5, 0.414_398_322_117_16),
        ];
    ...
    fn riemann_zeta_matches_scipy_at_small_s() {
        ...
        let cases: [(f64, f64); 5] = [
            (1.05, 20.580_844_302_036_99),
            (1.1, 10.584448464950802),
            (1.2, 5.591582441177753),
            (1.5, 2.612_375_348_685_488),

    ...
    G: Fn(ComplexAiryResult) -> Complex64 + Sync,
{
    match input {
        ...
        SpecialTensor::RealVec(values) => par_map_indices(values.len(), |i| {
            airy_scalar(values[i], mode).map(&real_kernel)
        })
...
mod tests {
    ...
    fn airy_complex_central_sector_matches_scipy() {
        ...
        let cases: [(f64, f64, f64, f64, f64, f64, f64, f64, f64, f64); 12] = [
            (
                12.0,
                0.5,
                -2.4223414693430455e-14,
                -1.3974098701294474e-13,
                7.446112193272591e-14,
                4.887737803938679e-13,
                -48652067274.85256,
                320162243852.3775,
                -190933928219.77063,
                1098999083686.9447,
            ...
            (
                8.0,
                3.0,
                -7.058972727591042e-08,
                -7.317318108006393e-08,
                1.6747620674528355e-07,
                2.4855341234540196e-07,
                -297016.0531185522,
                445697.65842547565,
                -1083279.7789608021,
                1111317.9040240769,
            ...
            (
                30.0,
                10.0,
                3.618458953201419e-48,
                2.9257065097289863e-47,
                6.168937330418648e-48,
                -1.658694314234755e-46,
                -3.630631225831182e43,
                -9.593640196678464e44,
                6.653289658499513e44,
                -5.3508198540913276e45,
            ),
            (
                50.0,
                -20.0,
                -2.660839071359235e-98,
                -4.7566497749799595e-98,
                2.577817445862617e-97,
                3.060871618150333e-97,
                -2.5643518267413724e95,
                3.042772476044945e95,
                -1.423970279550298e96,
                2.54760527821912e96,
            ),
            (
                15.0,
                15.0,
                -1.5242800743788593e-12,
                1.2389854126760803e-12,
                8.6723805670531e-12,
                -2.6084397373508288e-12,
                -16857882233.977169,
                -5027056464.473259,
                -62690727994.078316,
                -51203923689.169716,
            ...
            (
                100.0,
                5.0,
                4.7695734721577605e-291,
                1.206674397092088e-291,
                -4.7421090640946345e-290,
                -1.326494655264371e-290,
                3.113408464869102e288,
                -8.709662650827697e287,
                3.135381989425959e289,
                -7.931711005106893e288,
            ),
            ...
            (
                -5.209445,
                29.544233,
                4.3729991233689414e39,
                1.8642994451756372e40,
                6.267897923566469e40,
                -8.39216874836103e40,
                -1.8642994451756374e40,
                4.3729991233689475e39,
                8.392168748361032e40,
                6.267897923566468e40,
            ),
            (
                -17.320508,
                -10.0,
                -2.147716187256085e17,
                1.6933911234095622e17,
                -4.841992732506972e17,
                -1.1205809126338249e18,
                1.693391123409563e17,
                2.147716187256086e17,
                -1.120580912633825e18,
                4.841992732506968e17,
            ),
            (
                -48.296291,
                12.940952,
                -1.5230310279685878e38,
                -4.221312927245886e37,
                -1.560507108026517e38,
                1.1062930340529214e39,
                4.2213129272458804e37,
                -1.5230310279685882e38,
                -1.1062930340529215e39,
                -1.5605071080265167e38,
            ),
            (
                0.0,
                12.0,
    ...
    fn airy_positive_x_transition_band_matches_scipy() {
        ...
        let cases = [
            (
                4.0,
                9.5156385120480239e-04,
                -1.9586409502041799e-03,
                8.3847071408468125e+01,
                1.6192668350461341e+02,
            ),
            (
                4.5,
                3.3025032351430934e-04,
                -7.1786656755750973e-04,
                2.2758808183559970e+02,
                4.6913507732796637e+02,
            ),
            (
                5.0,
                1.0834442813607433e-04,
                -2.4741389086846232e-04,
                6.5779204417117126e+02,
                1.4358190802179822e+03,
            ),
            (
                5.5,
                3.3685311908599812e-05,
                -8.0463391305565131e-05,
                2.0165800386595311e+03,
                4.6325537331390415e+03,
            ),
            (
                5.9,
                1.2747094509184485e-05,
                -3.1481297117112759e-05,
                5.1442181542808012e+03,
                1.2266577761776951e+04,
            ),
            (
                7.0,
                7.4921288639971570e-07,
                -2.0081508947387894e-06,
                8.0327790709430265e+04,
                2.0955267087397128e+05,
            ),
            (
                10.0,
                1.1047532552898654e-10,
                -3.5206336767389118e-10,
                4.5564115354822654e+08,
                1.4292361344828701e+09,
            ),
        ];
        for (x, ai_ref, aip_ref, bi_ref, bip_ref) in cases {
            let r = airy_scalar(x, RuntimeMode::Strict).unwrap();
            assert!(
                (r.ai - ai_ref).abs() <= 1e-6 * ai_ref.abs(),
                "Ai({x}) = {}, scipy {ai_ref}",
                r.ai
            );
            assert!(
                (r.aip - aip_ref).abs() <= 1e-6 * aip_ref.abs(),
                "Ai'({x}) = {}, scipy {aip_ref}",
                r.aip
            );
            assert!(
                (r.bi - bi_ref).abs() <= 1e-6 * bi_ref.abs(),
                "Bi({x}) = {}, scipy {bi_ref}",
                r.bi
            );
            assert!(
                (r.bip - bip_ref).abs() <= 1e-6 * bip_ref.abs(),
                "Bi'({x}) = {}, scipy {bip_ref}",
                r.bip
            );
        }
    ...
    fn airy_negative_seam_ai_bi_match_mpmath() {
        ...
        for (x, ai_ref, bi_ref) in [
            (
                -10.5_f64,
                -0.311_926_035_051_050_6_f64,
                -0.030_356_123_264_021_012_f64,
            ),
